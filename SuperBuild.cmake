...
option(USE_SYSTEM_GDCM "Build using an externally defined version of GDCM" OFF)
option(BUILD_SHARED_LIBS "Build shared libraries" ON)
#------------------------------------------------------------------------------
# ${LOCAL_PROJECT_NAME} dependency list
#------------------------------------------------------------------------------

set(${LOCAL_PROJECT_NAME}_DEPENDENCIES ITKv4 VTK GDCM)
...
ExternalProject_Add(${proj}
  ...
  CMAKE_ARGS
    ...
    -DUSE_SYSTEM_GDCM:BOOL=${USE_SYSTEM_GDCM}
  INSTALL_COMMAND ""
  )
