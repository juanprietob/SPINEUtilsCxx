...
void PolyDataImageStencilExport(vtkPolyData* polydata, vtkImageData *imagein){
...
int main(int argv, char *argc[])
{
    ...
    for(unsigned i = 0; i < contours->GetNumberOfItems(); i++){
        ...
        vtkSmartPointer<vtkLinearExtrusionFilter>::New();
          extruder->SetInputData(interpolation->GetOutput());
        ...
        PolyDataImageStencilExport(extruder->GetOutput(), img);
